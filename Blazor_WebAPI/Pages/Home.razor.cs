...
public sealed partial class Home
{
    ...
    private void GoToLogin() => NavigationManager.NavigateToLogin("authentication/login");

    private void GoToLogout() => NavigationManager.NavigateToLogout("authentication/logout");
